...
// * This test class verifies the functionality of the Player Service by interacting with the actual
// * application context, including web environment and database operations.
// *
// * Commented out due to misconfiguration. Will revisit in sprint 5.
// */
...
//     * Initializes a UserDetails object with admin credentials and generates a JWT token.
//     */
//
//    @BeforeEach
//    public void setUp() {
...
//
//    /**
//     * Tests the successful creation of a player profile.
//     * This method validates that a new Player and associated Profile are correctly created
...
//
//    /**
//     * Tests the PUT endpoint for updating player details.
//     * This test constructs a PlayerDTO object with the player's information,
//     * sends a PUT request to update these details, and verifies the response.
//     * The validity of the player ID in the response is also asserted.
//     */
//    @Test
